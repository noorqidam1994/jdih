...
const Putusanpengadilan = ({ data }) => {
  ...
  function clickDetailEvent(j, n, t) {
    ...
    router.push('/detailputusan/'+noSlashj+'/'+noSlash+'/'+t, undefined, { shallow: true })
  }
  ...
  const handleClickbtnSearch = csp => {
    ...
    router.push('/putusan-pengadilan/'+lctx[1]+'/'+encodeURI(link), undefined, { shallow: true })
  }
  ...
  const hendleBtnTerapkan = trapkan => {
    ...
    router.push('/putusan-pengadilan/'+lctx[1] + akuksearch, undefined, { shallow: true })
  }
  ...
  return (
    ...
    <div className="loading" style={{display: 'none'}}>Loading...</div>
      ...
      return (
      <section className="dataLoad col-12 col-md-12 mt-3" key={d.idputusan} id={d.idputusan}>
      ...
      <div className="caption" onClick={() => clickDetailEvent(d.jenis_putusan, d.nomor_putusan, d.tahun_putusan)}>
      <p className="group inner list-group-item-text pstyle d1"style={{fontSize: "large"}}>{d.jenis_putusan.toUpperCase()} NOMOR {d.nomor_putusan} TAHUN {d.tahun_putusan}</p>
      <p className="group inner list-group-item-text d4">{d.judul_putusan.toLowerCase()}</p>
      ...
      <div className="filter-jdih-header" id="h_jenis">Jenis Putusan</div>	
      <div className="container pl-0 pr-0" id="listJns">
      {djenis && djenis.map(item => (
        <label className="option_item" key={item.jenis_putusan} id={item.jenis_putusan}>
        <input type="checkbox" className="checkbox chckjenis" name="jns[]" value={item.jenis_putusan} />
        <div className="option_inner _jdih">
        <div className="tickmark"></div>
      ...
      <div className="filter-jdih-header" id="h_tahun">Tahun Putusan</div>
      ...
      {dtahun && dtahun.map(item => (
        <label className="option_item" key={item.tahun_putusan} id={item.tahun_putusan}>
        <input type="checkbox" className="checkbox chcktahun" name="thn[]" value={item.tahun_putusan} />
        <div className="option_inner _jdih">
        <div className="tickmark"></div>
